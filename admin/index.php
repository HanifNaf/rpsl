...
<div class="container">
  <div class="text-right">
    <img src="../img/rpsl1.png" style="width: 110px; filter: drop-shadow(3px 4px 3px black)">
  </div>
</div>
...
<div class="container">
  ...
  <div class="col-sm">
    <a href="operasional" target="_blank" style="text-decoration: none;">
  ...
  <div class="col-sm">
    <a href="timbangan" target="_blank" style="text-decoration: none;">
  ...
  <div class="col-sm">
    <a href="boiler" target="_blank" style="text-decoration: none;">
...
<div class="col-sm">
  <a href="wtp" target="_blank" style="text-decoration: none;">
...
<div class="col-sm">
  <a href="turbin" target="_blank" style="text-decoration: none;">
