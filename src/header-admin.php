      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a href="<?= SITE_URL?> /public/operasional/operasional" class="nav-item nav-link">
            <svg style="width:24px;height:24px" viewBox="0 0 100 100">
        ...
        <li class="nav-item">
          <a href="<?= SITE_URL?> /public/operasional/operasional_maintenance" class="nav-item nav-link">
            <svg style="width:24px;height:24px" viewBox="0 0 100 100">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="wtpDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
           ...
           <div class="dropdown-menu" aria-labelledby="wtpDropdown">
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/wtp/sungai">Sungai</a>
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/wtp/cooling_tower">Cooling Tower</a>
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/wtp/boiler">Boiler</a>
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/wtp/ro">RO</a>
          </div>
        </li>

        <li class="nav-item">
          <a href="<?= SITE_URL;?> /public/hrd/pelanggaran" class="nav-item nav-link">
            <svg style="width:24px;height:24px" viewBox="0 0 30 30">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="operasionalDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
           ...
           <div class="dropdown-menu" aria-labelledby="operasionalDropdown">
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/hse/kecelakaan_kerja">Kecelakaan Kerja</a>
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/hse/pengawasan">Pengawasan Pekerjaan</a>
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/hse/potensi_bahaya">Potensi Bahaya</a>
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/hse/pelanggaran">Pelanggaran</a>
          </div>
        </li>
      </ul>
