      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="wtpDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
           ...
           <div class="dropdown-menu bg-success" aria-labelledby="wtpDropdown">
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/wtp/sungai" style="color: white;">Sungai</a>
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/wtp/cooling_tower" style="color: white;">Cooling Tower</a>
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/wtp/boiler" style="color: white;">Boiler</a>
            <a class="dropdown-item" href="<?= SITE_URL ?>/public/wtp/ro" style="color: white;">RO</a>
...
=======
        <li class="nav-item dropdown">
          <a href="<?= SITE_URL ?>/public/hse/kecelakaan_kerja" class="nav-item nav-link">
>>>>>>> a0f31ff3227571a4fbc2261166f784e30ffd889f
