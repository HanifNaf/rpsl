            ...
            columns: [
				...
				} },
                {
                    ...
                    "render": function(data, type, row, meta) {
                        var editButton = '<a href="cooling_tower_edit?id=' + row.cooling_tower_id + '" class="btn btn-warning btn-custom d-flex justify-content-center align-items-center">Edit</a>';
                        var deleteButton = '<a href="cooling_tower_delete?id=' + row.cooling_tower_id + '" class="btn btn-danger btn-custom d-flex justify-content-center align-items-center" onclick="return confirm(\'Apakah Anda yakin ingin menghapus data ini?\')">Hapus</a>';
...
<body class="container-fluid">
    <center><h3>PEMAKAIAN CHEMICAL COOLING TOWER</h3></center>
    <br>
    <!-- Menampilkan tabel -->
