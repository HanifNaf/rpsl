        ...
        <div class="card text-white mb-3" style="background-color: #006A4E; max-width: 11rem; filter: drop-shadow(3px 4px 3px black)">
          <div class="card-body">
            <svg style="width:40px;height:40px; float: right; margin-top: 5px;" viewBox="0 0 69 69">
              <path fill="#FFFFFF" d="M66,8H40a3.00883,3.00883,0,0,0-3,3V61a3.00887,3.00887,0,0,0,3,3H66a3.00883,3.00883,0,0,0,3-3V11A3.00879,3.00879,0,0,0,66,8ZM46,53h9a1,1,0,0,1,0,2H46a1,1,0,0,1,0-2Zm-1-7a1.003,1.003,0,0,1,1-1h9a1,1,0,0,1,0,2H46A1.003,1.003,0,0,1,45,46Zm3,5a1,1,0,0,1,0-2h9a1,1,0,0,1,0,2Zm-5-8a1,1,0,0,1,0-2H62a1,1,0,0,1,0,2Zm0,14H62a1,1,0,0,1,0,2H43a1,1,0,0,1,0-2ZM53,37A12,12,0,1,1,65,25,12.00951,12.00951,0,0,1,53,37Z"/><path fill="#FFFFFF" d="M32,8H6a3.00883,3.00883,0,0,0-3,3V32a3.00887,3.00887,0,0,0,3,3H32a3.00883,3.00883,0,0,0,3-3V11A3.00879,3.00879,0,0,0,32,8ZM8,30V24a1.003,1.003,0,0,1,1-1h4a1.003,1.003,0,0,1,1,1v6a1.003,1.003,0,0,1-1,1H9A1.003,1.003,0,0,1,8,30Zm8,0V19a1.003,1.003,0,0,1,1-1h4a1.003,1.003,0,0,1,1,1V30a1.003,1.003,0,0,1-1,1H17A1.003,1.003,0,0,1,16,30Zm14,0a1.003,1.003,0,0,1-1,1H25a1.003,1.003,0,0,1-1-1V13a1.003,1.003,0,0,1,1-1h4a1.003,1.003,0,0,1,1,1Z"/><path fill="#FFFFFF" d="M32,37H6a3.00883,3.00883,0,0,0-3,3V61a3.00887,3.00887,0,0,0,3,3H32a3.00883,3.00883,0,0,0,3-3V40A3.00879,3.00879,0,0,0,32,37Zm-1.29,7.71-8.59,8.58a3.05578,3.05578,0,0,1-4.24,0l-1.17-1.17a1.02684,1.02684,0,0,0-1.42,0L8.71,58.71a1.014,1.014,0,0,1-1.42,0,1.0079,1.0079,0,0,1,0-1.42l6.59-6.58a3.0559,3.0559,0,0,1,4.24,0l1.17,1.17a1.02684,1.02684,0,0,0,1.42,0l8.58-8.59a1.00408,1.00408,0,0,1,1.42,1.42Z"/><path fill="#FFFFFF" d="M54,15.05V24h8.95A10.01184,10.01184,0,0,0,54,15.05Z"/><path fill="#FFFFFF" d="M52,25V15.05A10.00007,10.00007,0,1,0,62.95,26H53A1.003,1.003,0,0,1,52,25Z"/>
            </svg>
            <p class="card-text">RPSL DASHBOARD</p>
          </div>
        </div>
      </a>
    <?php }  ?>
...
<div class="container">
  <div class="row">
    <div class="col-sm">
      <a href="operasional/operasional" style="text-decoration: none;">
        <div class="card text-white mb-3" style="background-color:#FF0000; max-width: 18rem;filter: drop-shadow(3px 4px 3px black)">
.024,.539,.071,.531,.142,.973,.48,1.244,.951l15.091,26.139Zm69.262-21.733l-33.813,19.522c-1.638,.946-3.538,1.199-5.35,.713l-23.198-6.216c-.014-.004-.028-.007-.043-.01-1.817-.404-3.058-.571-4.955,.524l-2.774,1.602-9.808-16.988,16.631-9.602c1.241-.717,3.068-.899,4.441-.444,.019,.006,.038,.012,.057,.017l23.268,6.235c1.147,.307,2.109,1.048,2.708,2.086s.76,2.241,.452,3.389c-.628,2.344-2.992,3.684-5.381,3.055l-17.501-4.634c-.546-.144-1.105,.181-1.25,.727-.145,.546,.181,1.105,.727,1.25l17.493,4.632s0,0,0,0h0s2.787,.738,2.787,.738c1.882,.498,2.857,.161,5.466-1.345l24.803-14.32c2.501-1.444,5.71-.584,7.154,1.917,1.444,2.501,.584,5.71-1.917,7.154Zm-3.485-18.186H46.649c.517-14.641,12.047-21.32,22.778-21.32h.008c10.613,.003,22.016,6.685,22.518,21.32Zm-12.06-33.98c0,1.235-.209,2.438-.621,3.584h-6.954c-.805,0-1.46,.655-1.46,1.46v3.129c0,.805,.655,1.46,1.46,1.46h1.43c-1.387,.647-2.899,.984-4.472,.984-5.854,0-10.617-4.763-10.617-10.617s4.763-10.617,10.617-10.617,10.617,4.763,10.617,10.617Z" /></svg>
    ...
    <div class="col-sm">
      <a href="maintenance/maintenance" style="text-decoration: none;">
        <div class="card text-white mb-3" style="background-color:#FFA500; max-width: 18rem; filter: drop-shadow(3px 4px 3px black)">
          <div class="card-body">
            <svg style="width:40px;height:40px; float: right; margin-top: 5px;" viewBox="0 0 100 100"><<path fill="#ffffff" d="M92,81.2c1,1,1,2.5,0,3.5l-7.5,7.5c-1,1-2.5,1-3.5,0L52.4,63.4l11-11L92,81.2z"/><path fill="#FFFFFF" d="M12.8,19.4l-6.4-8.8l4.5-4.5l8.8,6.4l3.5,5.8l-0.5,0.5l14.9,15.1l5-5l4.4,4.4l-1.2,1.2l1.9,1.9l-11,11l-1.9-2l-1.2,1.2  l-4.4-4.4l5-5L19.1,22.3l-0.5,0.5L12.8,19.4z"/><path fill="#FFFFFF" d="M34.8,89.9c-4.7,4.7-11.4,6.2-17.3,4.4l8.2-8.2l-2.5-9.2L14,74.4l-8.2,8.2C4,76.6,5.4,69.9,10.1,65.2  c4.8-4.8,11.7-6.2,17.8-4.2L61,27.9c-2-6-0.6-13,4.2-17.8C69.9,5.4,76.6,4,82.6,5.7L74.3,14l2.5,9.2l9.2,2.5l8.2-8.2  c1.8,5.9,0.3,12.6-4.4,17.3C85.1,39.6,78.1,41,72.1,39L39,72.1C41,78.2,39.6,85.1,34.8,89.9z" />></svg>
    ...
    <div class="col-sm">
      <a href="hse/hse_cabang" style="text-decoration: none;">
        <div class="card text-white mb-3" style="background-color: #28a745; max-width: 18rem; filter: drop-shadow(3px 4px 3px black)">
          <div class="card-body">
