            ...
            columns: [
                 ...
                 }},
                {
                    ...
                    "render": function(data, type, row, meta) {
                        var editButton = '<a href="pelanggaran_edit.php?id=' + data.pelanggaran_id + '" class="btn btn-warning btn-custom d-flex justify-content-center align-items-center">Edit</a>';
                        var deleteButton = '<a href="pelanggaran_delete.php?id=' + data.pelanggaran_id + '" class="btn btn-danger btn-custom d-flex justify-content-center align-items-center" onclick="return confirm(\'Apakah Anda yakin ingin menghapus data ini?\')">Hapus</a>';
