    ...
    <div class="col-sm">
      ...
      <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
        <div class="card-body">
          ...
          <p class="card-text">OPERASIONAL HARIAN</p>
        </div>
      </div>
      </a>
    </div>
